...
public class Question6 implements Initializable {
    ...
    void submit(ActionEvent event) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(Question7.class.getResource("Question7.fxml"));
...
//            Next 2 lines sends the username to the first question in the result array
            ...
            question7.sendToNext(results, i);

            Stage questionStage = new Stage();
            questionStage.setScene(new Scene(questionRoot));
            questionStage.setTitle("Question 7");
            questionStage.show();
